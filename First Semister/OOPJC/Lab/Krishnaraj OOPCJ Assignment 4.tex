...
\lstinputlisting[language=c++, caption=Main.Cpp]{../Programs/cpp_implementations/Krishnaraj_Assignment_4.cpp}

\subsubsection{C++ Output}
\lstinputlisting[caption=Output for Problem 1]{../Programs/cpp_implementations/krishnaraj_Assignment_4_output.txt}

\subsection{Java Implementation of Problem B}

\lstinputlisting[language=java, caption=Division.java]{../Programs/java_implementations/assignment_4/[Assignment 4] [Java] Division.java}

\subsubsection{Java Output}
\lstinputlisting[caption=Output for Problem 2]{../Programs/java_implementations/assignment_4/[Assignment 4] [Java] problem_b_output.txt}

\subsection{Java Implementation of Problem C}

\lstinputlisting[language=java, caption=HillStation]{../Programs/java_implementations/assignment_4/[Assignment 4] [Java] Employee.java}

\subsubsection{Java Output}
\lstinputlisting[caption=Output for Problem 3]{../Programs/java_implementations/assignment_4/[Assignment 4] [Java] Problem_B_output.txt}

\subsection{Java Implementation of Problem D}

\lstinputlisting[language=java, caption=HillStation]{../Programs/java_implementations/assignment_4/[Assignment 4] [java] Bank.java}

\lstinputlisting[language=java, caption=HillStation]{../Programs/java_implementations/assignment_4/[Assignment 4] [java] Main.java}
\subsubsection{Java Output}
\lstinputlisting[language=java, caption=Main.java]{../Programs/java_implementations/assignment_4/[Assignment 4] [java] problem_d_output.txt}
