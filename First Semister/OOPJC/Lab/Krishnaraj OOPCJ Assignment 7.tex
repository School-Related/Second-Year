...
\lstinputlisting[language=java, caption=Full Time Employee.java]{../Programs/java_implementations/assignment_7/assignment_7_problem_1.java}

\subsubsection{Java Output}
\lstinputlisting[caption=Output for Problem 1]{../Programs/java_implementations/assignment_7/problem_1_output.txt}

\subsection{Java Implementation of Problem 2}

\lstinputlisting[language=java, caption=HillStation]{../Programs/java_implementations/assignment_7/assignment_7_problem_2.java}

\subsubsection{Java Output}
\lstinputlisting[caption=Output for Problem 2]{../Programs/java_implementations/assignment_7/problem_2_output.txt}
